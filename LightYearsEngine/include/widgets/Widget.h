...
namespace ly {
	...
	public:
		...
		sf::Vector2f GetWidgetLocation() const { return mWindgetTransform.getPosition(); }
		float GetWidgetRotation() const { return mWindgetTransform.getRotation(); }
	...
	private:
		...
		sf::Transformable mWindgetTransform;
		bool mIsVisible;
	};
}